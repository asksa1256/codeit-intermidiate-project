...
const RangeSliderReadonly = ({ className, value }: RangeSliderReadonlyProps) => {
  ...
  return (
    <div className={clsx('flex items-center w-28 h-4 md:w-99', className)}>
      <div className='w-full h-[10px] rounded-[50px] border-1 border-gray-300 bg-gray-100 relative'>
        <div className='absolute top-[50%] translate-[-50%] w-[28px] h-[28px]' style={handleStyle}>
